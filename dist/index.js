...
var McpService = class _McpService extends Service {
  ...
  async initialize(runtime) {
    ...
    if (settings?.servers) {
      ...
      logger6.info("No MCP servers configured in character settings.");
    }
  }
...
${error}` : error;
  ...
  getMcpSettings() {
    ...
    try {
      ...
      logger6.error("Failed to parse MCP settings:", error instanceof Error ? error.message : String(error));
      return void 0;
    }
  }
};
